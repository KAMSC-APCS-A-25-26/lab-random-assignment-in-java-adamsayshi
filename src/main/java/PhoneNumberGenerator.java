...
public class PhoneNumberGenerator {
    public static void main(String[] args) {
        ...
        String first = Integer.toString(rand.nextInt(8)) + Integer.toString(rand.nextInt(8)) + Integer.toString(rand.nextInt(8));
        // TODO: Generate second three digits (XXX) 
        // Constraint: Must be <= 742 (000-742)
        String second = Integer.toString(rand.nextInt(742));
        // TODO: Generate third three digits (XXX)
        // No constraints (000-999)
        String formatLast = String.format("%03d", rand.nextInt(999));
        // TODO: Format and display phone number as XXX-XXX-XXX
        // Include the dashes in the output
        System.out.println(first + "-" + second + "-" + formatLast);
    }
